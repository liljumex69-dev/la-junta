...
import { ChartLineUp, ChatCircleDots, House } from "@phosphor-icons/react/ssr";
 ...
 * pantalla, nunca escondida dentro de un menú.
 */
const DESTINOS = [
  { href: "/inicio", label: "Inicio", icono: House },
  { href: "/historial", label: "Historial", icono: ChartLineUp },
...
export function BottomNav() {
  ...
  return (
    <nav
      ...
      className="sticky bottom-0 z-40 border-t border-minka-border bg-minka-surface"
            ...
            <li key={d.href} className="flex-1">
              <Link
                ...
                className={cn(
                  ...
                  activo
                    ? "text-minka-primary"
                    : "text-minka-muted hover:text-minka-text"
                )}
              >
                <Icono
                  size={26}
